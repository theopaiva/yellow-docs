...
<Info>
Exchange information (markets, precisions, fees) is available per product at [`GET /spot/exchangeInfo`](/api-and-programmatic-access/spot-trading-api) and [`GET /perpetual/exchangeInfo`](/api-and-programmatic-access/perpetuals-trading-api).
</Info>
