...
![Selecting a market on the Yellow.pro trading interface](/images/selecting-a-market-on-the-yellow-pro-trading-int.png)
</Step>
...
![The order form with the order-type selector](/images/the-order-form-with-the-order-type-selector.webp)
...
![An open order shown in the Open Orders panel](/images/an-open-order-shown-in-the-open-orders-panel.png)

**Filled order:**

![A filled order shown in trade history](/images/a-filled-order-shown-in-trade-history.png)
</Step>
</Steps>
...
![Cancelling an open order from the Open Orders tab](/images/cancelling-an-open-order-from-the-open-orders-ta.png)
