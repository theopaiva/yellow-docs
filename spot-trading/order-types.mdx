...
![The order form with a conditional (stop) order selected](/images/zM2jdbY6SDAwYqzDF8Kg)
...
![Setting a Take Profit / Stop Loss order in the order form](/images/vIIXTgl5fg733QKySE6M)
