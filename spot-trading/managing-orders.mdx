...
![The Open Orders panel](/images/an-open-order-shown-in-the-open-orders-panel.png)
...
![The Order History view](/images/the-order-history-view.png)
...
![The Trade History (fill history) view](/images/the-trade-history-fill-history-view.png)
