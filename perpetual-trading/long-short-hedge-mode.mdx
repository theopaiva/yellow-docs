...
![A long and a short position held on the same market at the same time in Two-Way (Hedge) Mode](/images/a-long-and-a-short-position-held-on-the-same-mar.png)
