...
![Closing a position with the ✕ button in the Positions panel](/images/closing-a-position-with-the-button-in-the-positi.png)
...
![Closing through the order form's Close tab](/images/closing-through-the-order-form-s-close-tab.png)
