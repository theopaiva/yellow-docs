...
![Connect via External Wallet](/images/connect-via-external-wallet.png)
</Step>
...
<Frame caption="Connect via Google Account">
  <img src="/images/connect-via-google-account.gif" alt="Connect via Google Account" />
</Frame>
...
<Frame caption="Connect via WalletConnect">
  <img src="/images/connect-via-walletconnect.gif" alt="Connect via WalletConnect" />
</Frame>
...
<Frame>
  <img src="/images/connect-your-wallet-1.gif" alt="" />
</Frame>
