...
<Frame caption="External Wallet Deposit">
  <img src="/images/external-wallet-deposit.gif" alt="External Wallet Deposit" />
</Frame>
...
<Frame caption="Deposit To Account Balance (Gmail Sign-in)">
  <img src="/images/deposit-to-account-balance-gmail-sign-in.png" alt="Deposit To Account Balance (Gmail Sign-in)" />
</Frame>
...
<Frame caption="Account Balance To Trading (Spot) Account Transfer">
  <img src="/images/account-balance-to-trading-account-transfer.gif" alt="Account Balance To Trading (Spot) Account Transfer" />
</Frame>
