...
![Withdrawal via External Wallet](/images/withdrawal-via-external-wallet.gif)
...
<Frame caption="Perpetual Account To Trading (Spot) Account To Account Balance Transfer">
  <img src="/images/perpetual-account-spot-account-account-balance-t.gif" alt="Perpetual Account To Trading (Spot) Account To Account Balance Transfer" />
</Frame>
...
<Frame caption="Withdraw To External Wallet From Account Balance">
  <img src="/images/withdraw-to-external-wallet-from-account-balance.gif" alt="Withdraw To External Wallet From Account Balance" />
</Frame>
